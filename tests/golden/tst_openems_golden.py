...
settings['margin'] = 55    # @brief Distance from GDSII geometry boundary to simulation boundary, in project units

settings['fstart']   = 0e9  # @brief start frequency [Hz]
settings['fstop']    = 110000000000 # @brief stop frequency [Hz]
settings['numfreq']  = 123  # @brief number of frequency steps [Hz]
