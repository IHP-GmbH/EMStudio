...
# Model comments
# 
# Test SG13G2 resistor RSIL with a nominal value of 50 Ohm
# Ports 201/202 connect to RSIL
...
settings['unit']   = 1e-06  # geometry is in microns
settings['margin'] = 10    # distance in microns from GDSII geometry boundary to simulation boundary 

settings['fstart']  = 0e9
settings['fstop']   = 10000000000
...
# settings['no_preview']=True  # skip preview of outlines, show meshed metals only
